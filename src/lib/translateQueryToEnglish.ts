...
const PACK_KO_EN: [string, string][] = [
  ...
  //    한국에서도 나와서 "맥도날드"로 치는데(운영 검색 기록 30번), 우리 사전에는
  //    "McDonald's Collection"이라는 영문 이름만 있어 **목록이 통째로 비었다**
  //    (2026-08-08 확인). 한글 이름은 사장님이 "맥도날드 컬렉션"으로 정해 주셨다.
  //    ⚠️ 연도까지 치는 사람도 있으므로 "맥도날드 컬렉션 2024"처럼 뒤에 숫자가 붙어도
  //       "McDonald's Collection 2024"가 되게 **연도는 안 건드리고 앞부분만** 바꾼다.
  ['맥도날드 컬렉션', "McDonald's Collection"],
  ['맥도날드', "McDonald's Collection"],
  ['포켓몬카드 151', '151'],
