...
const EXTRA = [
  ...
  // 일본판 프로모. TCGdex 목록에 아예 없어서 통째로 빠져 있었다(1,734장).
  // 우리 검색 기록에서 "프로모"류가 38회 나오는 인기 자리인데, 지금까지 북미판만
  // 있었다. limitless 코드는 시대별로 <시리즈>P다(2026-08-02 확인).
  { id: 'SVP', name: 'スカーレット&バイオレット プロモ', releaseDate: '2023-01-20', serie: 'ポケモンカードゲーム スカーレット&バイオレット' },
  { id: 'SP', name: 'ソード&シールド プロモ', releaseDate: '2019-12-06', serie: '剣と盾' },
  { id: 'SMP', name: 'サン&ムーン プロモ', releaseDate: '2016-12-09', serie: 'サン＆ムーン' },
  { id: 'XYP', name: 'XY プロモ', releaseDate: '2013-11-08', serie: 'XY' },
  { id: 'BWP', name: 'ブラック&ホワイト プロモ', releaseDate: '2010-12-17', serie: 'ブラック＆ホワイト' },
]
