...
{"found": true, "pokemonNameEn": "이 카드의 포켓몬(또는 트레이너) 영어 이름. ex·V·VMAX·VSTAR·GX 표기가 있으면 포함(예: Greninja ex, Pikachu V). 카드가 일본어·한국어로 인쇄돼 있어도 반드시 영어 이름으로 답하라", "cardNumber": "카드 번호(예: 086/083, 209/XY-P, 025/165). 라벨이나 카드에서 읽되, 반사로 흐릿해 확실치 않으면 절대 지어내지 말고 null. 틀린 번호보다 null이 낫다", "edition": "카드에 인쇄된 언어 기준. 일본어나 한국어면 \\"japanese\\", 영어면 \\"english\\""}
